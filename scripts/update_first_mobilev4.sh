#!/bin/bash
# Update First_mobilev4 traffic route IPs from tcp5.com
# Runs daily via cron

set -euo pipefail

LOG_TAG="update_first_mobilev4"
RSC_URL="http://ros.tcp5.com/list/mobile_latest.rsc"
MONGO_CMD="mongo --quiet --port 27117 ace"
ROUTE_DESC="First_mobilev4"
IPSET_NAME="UBIOS4trafficroute_ip_3"
TMP_FILE="/tmp/mobile_ips.tmp"
TMP_JS="/tmp/mobile_update.js"
TMP_IPS="/tmp/mobile_ips_list.txt"
LOG_FILE="/data/custom/update_first_mobilev4.log"
